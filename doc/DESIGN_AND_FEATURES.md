...
Different events vary in severity. We cannot treat an alert for a new version of Initia as being on the same level as an alert for validator downtime. PANIC makes use of four alert types:
